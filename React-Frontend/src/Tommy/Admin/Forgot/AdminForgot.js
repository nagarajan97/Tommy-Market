...
export class AdminForgot extends React.Component {
  check = () => {
  ...
  submit = (e) => {
    ...
    if (
      ...
      axios
        .post("http://localhost:56064/Api/Market/AdminForgot", {
        ...
        .then((x) => {
          if (x.data)
            ...
            document.querySelector(".alert1").innerHTML =
              "Invalid AdminID or PIN Provided!";
            document.querySelector(".alert1").classList.remove("hide");
            this.props.history.push("/AdminForgot");
          }
        });
  };
  render = () => {
