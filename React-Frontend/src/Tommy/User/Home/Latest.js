...
export class Latest extends React.Component {
  ...
  changeslide = (pos) => {
    document.querySelector(".slide").src = "./images/image1" + pos + ".jpg";
    document
  ...
  render = () => {
    ...
    Categories.push(
      <div className="cartegoryflex">
        ...
        <h1 className="Categorytitel2 cml">LATEST ZONE</h1>
